      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <a href="tel:+17089791549" className="text-green-400 hover:text-green-300">
                    (708) 979-1549
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@cashforjunks.site" className="hover:text-white transition-colors">
                  info@cashforjunks.site
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p>© 2024 Cash For Junks. All rights reserved.</p>
